...
export function drawBookshelf(g, x, y) {
  const w = TILE * 2;
  const h = TILE * 1.5;
...
export function drawPlant(g, x, y) {
...
export function drawWhiteboard(g, x, y) {
...
export function drawCoffeeMachine(g, x, y) {
...
export function drawFilingCabinet(g, x, y) {
  const w = TILE;
  const h = TILE * 1.5;
